export const enUS = {
  ...
  connectionErrors: {
    ...
    apiDesc: "The Obo API server could not be reached",
  ...
  notebooks: {
    ...
    emptyTitle: "Add a source to get started",
    emptyDesc: "Chat, notes, and Studio all work from your sources. Add one to begin.",
    updated: "Updated",
  ...
  settings: {
    ...
    sectionPodcastProfiles: "Podcast profiles",
    preferences: "Preferences",
    preferencesDesc: "Theme and language for this browser",
    workspace: "Workspace",
    workspaceDesc: "Manage who can access this workspace",
    localAccountDesc: "You're signed in with a local password, so there's no account profile to show.",
    ...
    jina: "Jina",
    crawl4ai: "Crawl4AI",
    enableDoclingHint: "Docling is optional. Enable it with OBO_ENABLE_DOCLING=true — it installs on first startup (a large download).",
    enableCrawl4aiHint: "Local Crawl4AI is optional. Enable it with OBO_ENABLE_CRAWL4AI=true (installs on first startup), or set CRAWL4AI_API_URL to use a remote server.",
    ...
    filesHelp: "Once your files are uploaded and processed, they are not required anymore. Most users should allow Obo to delete uploaded files from the upload folder automatically.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "A new version of Obo is available.",
    upToDate: "Up to Date",
    unknown: "Unknown",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configure which models to use for different purposes across Obo",
    missingRequiredModels: "Missing required models: {{models}}. Obo may not function properly without these.",
  ...
  apiKeys: {
    description: "Store API keys securely in the database to enable AI providers in Obo.",
    encryptionRequired: "Encryption key not configured",
    encryptionRequiredDescription: "Set the OBO_ENCRYPTION_KEY environment variable to any secret string to enable storing API keys in the database.",
  ...
  setupBanner: {
    encryptionRequired: "Encryption key not configured",
    encryptionRequiredDescription: "Set the OBO_ENCRYPTION_KEY environment variable to enable secure credential storage.",
