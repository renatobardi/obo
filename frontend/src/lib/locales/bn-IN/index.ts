...
export const bnIN = {
  ...
  notebooks: {
    ...
    emptyTitle: "শুরু করতে একটি উৎস যোগ করুন",
    emptyDesc: "চ্যাট, নোট এবং স্টুডিও আপনার উৎস থেকে কাজ করে। শুরু করতে একটি যোগ করুন।",
    updated: "আপডেট করা",
  ...
  sources: {
    ...
    pasteLink: "একটি লিঙ্ক পেস্ট করুন",
  ...
  settings: {
    sectionProcessing: "প্রসেসিং",
    sectionPodcastProfiles: "পডকাস্ট প্রোফাইল",
    preferences: "পছন্দসমূহ",
    preferencesDesc: "এই ব্রাউজারের থিম ও ভাষা",
    workspace: "ওয়ার্কস্পেস",
    workspaceDesc: "কে এই ওয়ার্কস্পেস অ্যাক্সেস করতে পারবে তা পরিচালনা করুন",
    localAccountDesc: "আপনি একটি লোকাল পাসওয়ার্ড দিয়ে সাইন ইন করেছেন, তাই দেখানোর মতো কোনো অ্যাকাউন্ট প্রোফাইল নেই।",
    ...
    jina: "জিনা",
    crawl4ai: "Crawl4AI",
    enableDoclingHint: "Docling ঐচ্ছিক। OBO_ENABLE_DOCLING=true দিয়ে সক্রিয় করুন — এটি প্রথম চালুর সময় ইনস্টল হয় (বড় ডাউনলোড)।",
    enableCrawl4aiHint: "লোকাল Crawl4AI ঐচ্ছিক। OBO_ENABLE_CRAWL4AI=true দিয়ে সক্রিয় করুন (প্রথম চালুর সময় ইনস্টল হয়), অথবা রিমোট সার্ভার ব্যবহার করতে CRAWL4AI_API_URL সেট করুন।",
    ...
    filesHelp: "একবার আপনার ফাইল আপলোড এবং প্রক্রিয়া হওয়ার পর, সেগুলি আর প্রয়োজন নেই। বেশিরভাগ ব্যবহারকারী Obo কে আপলোড ফোল্ডার থেকে আপলোড করা ফাইল স্বয়ংক্রিয়ভাবে মুছে ফেলার অনুমতি দিতে পারেন।",
  ...
  advanced: {
    ...
    updateAvailableDesc: "Obo এর একটি নতুন সংস্করণ উপলব্ধ।",
    upToDate: "আপ টু ডেট",
    unknown: "অজানা",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Obo জুড়ে বিভিন্ন কাজের জন্য কোন মডেল ব্যবহার করব তা কনফিগার করুন",
    missingRequiredModels: "প্রয়োজনীয় মডেল অনুপস্থিত: {{models}}। এগুলি ছাড়া Obo সঠিকভাবে কাজ নাও করতে পারে।",
  ...
  apiKeys: {
    description: "Obo এ AI প্রোভাইডার সক্ষম করতে ডেটাবেসে নিরাপদভাবে API কী সংরক্ষণ করুন।",
    encryptionRequired: "এনক্রিপশন কী কনফিগার করা হয়নি",
    encryptionRequiredDescription: "ডেটাবেসে API কী সংরক্ষণ করতে OBO_ENCRYPTION_KEY environment variable যেকোন গোপন স্ট্রিংয়ে সেট করুন।",
  ...
  setupBanner: {
    encryptionRequired: "এনক্রিপশন কী কনফিগার করা হয়নি",
    encryptionRequiredDescription: "নিরাপদ credential স্টোরেজ সক্ষম করতে OBO_ENCRYPTION_KEY environment variable সেট করুন।",
