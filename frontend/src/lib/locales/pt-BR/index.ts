...
export const ptBR = {
  ...
  connectionErrors: {
    ...
    apiDesc: "O servidor da API do Obo não pôde ser alcançado",
  ...
  notebooks: {
    ...
    emptyTitle: "Adicione uma fonte para começar",
    emptyDesc: "Chat, notas e Studio funcionam a partir das suas fontes. Adicione uma para começar.",
    updated: "Atualizado",
  ...
  settings: {
    sectionProcessing: "Processamento",
    sectionPodcastProfiles: "Perfis de podcast",
    preferences: "Preferências",
    preferencesDesc: "Tema e idioma deste navegador",
    workspace: "Espaço de trabalho",
    workspaceDesc: "Gerencie quem pode acessar este espaço de trabalho",
    localAccountDesc: "Você entrou com uma senha local, então não há perfil de conta para mostrar.",
    ...
    jina: "Jina",
    crawl4ai: "Crawl4AI",
    enableDoclingHint: "O Docling é opcional. Ative-o com OBO_ENABLE_DOCLING=true — ele é instalado no primeiro início (download grande).",
    enableCrawl4aiHint: "O Crawl4AI local é opcional. Ative-o com OBO_ENABLE_CRAWL4AI=true (instalado no primeiro início) ou defina CRAWL4AI_API_URL para usar um servidor remoto.",
    ...
    filesHelp: "Uma vez que seus arquivos são enviados e processados, eles não são mais necessários. A maioria dos usuários deve permitir que o Obo exclua arquivos enviados da pasta de upload automaticamente.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "Uma nova versão do Obo está disponível.",
    upToDate: "Atualizado",
    unknown: "Desconhecido",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configure quais modelos usar para diferentes propósitos no Obo",
    missingRequiredModels: "Modelos obrigatórios ausentes: {{models}}. O Obo pode não funcionar corretamente sem eles.",
  ...
  apiKeys: {
    description: "Armazene chaves de API com segurança no banco de dados para habilitar provedores de IA no Obo.",
    encryptionRequired: "Chave de criptografia não configurada",
    encryptionRequiredDescription: "Configure a variável de ambiente OBO_ENCRYPTION_KEY com qualquer string secreta para armazenar chaves de API no banco de dados.",
  ...
  setupBanner: {
    encryptionRequired: "Chave de criptografia não configurada",
    encryptionRequiredDescription: "Configure a variável de ambiente OBO_ENCRYPTION_KEY para habilitar o armazenamento seguro de credenciais.",
  ...
  studio: {
    createDesc: "Gere uma nova saída a partir do contexto de chat deste notebook.",
    titleLabel: "Título",
    focusLabel: "Foco (opcional)",
    focusPlaceholder: "Restrinja a saída a um ângulo ou pergunta específica...",
    generate: "Gerar",
    generated: "Gerados",
    untitled: "Saída sem título",
    emptyHint: "As saídas geradas aparecem aqui como notas de IA.",
    created: "Saída criada",
    createdDesc: "Adicionada às notas deste notebook.",
    failed: "Não foi possível gerar a saída.",
    contextSummary: "{{sources}} fontes · {{notes}} notas",
    fromSources: "Gerado a partir do contexto de chat atual.",
    kindMindmap: "Mapa mental",
    kindMindmapDesc: "Um esquema hierárquico das ideias principais e como se conectam.",
    kindReport: "Relatório",
    kindReportDesc: "Um relatório escrito e estruturado cobrindo o material a fundo.",
    kindBriefing: "Briefing",
    kindBriefingDesc: "Um briefing executivo conciso com os pontos essenciais.",
    kindFaq: "FAQ",
    kindFaqDesc: "Perguntas frequentes respondidas a partir das fontes.",
    kindTimeline: "Linha do tempo",
    kindTimelineDesc: "Eventos e marcos em ordem cronológica.",
    kindFlashcards: "Flashcards",
    kindFlashcardsDesc: "Cartões de pergunta e resposta para recordação ativa.",
    kindQuiz: "Quiz",
    kindQuizDesc: "Um quiz curto de múltipla escolha para testar a compreensão.",
    kindPodcast: "Podcast",
    kindPodcastDesc: "Uma conversa em áudio entre dois apresentadores sobre o material.",
  },
