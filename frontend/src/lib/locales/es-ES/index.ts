...
export const esES = {
  ...
  connectionErrors: {
    ...
    apiDesc: "No se pudo alcanzar el servidor API de Obo",
  ...
  notebooks: {
    ...
    emptyTitle: "Añade una fuente para empezar",
    emptyDesc: "El chat, las notas y Studio funcionan a partir de tus fuentes. Añade una para empezar.",
    updated: "Actualizado",
  ...
  settings: {
    sectionProcessing: "Procesamiento",
    sectionPodcastProfiles: "Perfiles de podcast",
    preferences: "Preferencias",
    preferencesDesc: "Tema e idioma de este navegador",
    workspace: "Espacio de trabajo",
    workspaceDesc: "Gestiona quién puede acceder a este espacio de trabajo",
    localAccountDesc: "Has iniciado sesión con una contraseña local, así que no hay perfil de cuenta que mostrar.",
    ...
    jina: "Jina",
    crawl4ai: "Crawl4AI",
    enableDoclingHint: "Docling es opcional. Actívalo con OBO_ENABLE_DOCLING=true — se instala en el primer arranque (descarga grande).",
    enableCrawl4aiHint: "Crawl4AI local es opcional. Actívalo con OBO_ENABLE_CRAWL4AI=true (se instala en el primer arranque), o define CRAWL4AI_API_URL para usar un servidor remoto.",
    ...
    filesHelp: "Una vez que tus archivos se suben y procesan, ya no son necesarios. La mayoría de los usuarios deberían permitir que Obo elimine los archivos subidos de la carpeta de carga automáticamente.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "Una nueva versión de Obo está disponible.",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configura qué modelos usar para diferentes propósitos en Obo",
    missingRequiredModels: "Faltan modelos requeridos: {{models}}. Obo puede no funcionar correctamente sin estos.",
  ...
  apiKeys: {
    description: "Almacena claves API de forma segura en la base de datos para habilitar proveedores de IA en Obo.",
    encryptionRequired: "Clave de encriptación no configurada",
    encryptionRequiredDescription: "Establece la variable de entorno OBO_ENCRYPTION_KEY con cualquier cadena secreta para habilitar el almacenamiento de claves API en la base de datos.",
  ...
  setupBanner: {
    encryptionRequired: "Clave de encriptación no configurada",
    encryptionRequiredDescription: "Establece la variable de entorno OBO_ENCRYPTION_KEY para habilitar el almacenamiento seguro de credenciales.",
