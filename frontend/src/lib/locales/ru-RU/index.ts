...
export const ruRU = {
  ...
  connectionErrors: {
    ...
    apiDesc: "API-сервер Obo недоступен",
  ...
  notebooks: {
    ...
    emptyTitle: "Добавьте источник, чтобы начать",
    emptyDesc: "Чат, заметки и Studio работают на основе ваших источников. Добавьте один, чтобы начать.",
    updated: "Обновлено",
  ...
  settings: {
    ...
    sectionPodcastProfiles: "Профили подкастов",
    preferences: "Настройки",
    preferencesDesc: "Тема и язык для этого браузера",
    workspace: "Рабочее пространство",
    workspaceDesc: "Управляйте доступом к этому рабочему пространству",
    localAccountDesc: "Вы вошли с локальным паролем, поэтому профиль аккаунта отсутствует.",
    ...
    jina: "Jina",
    crawl4ai: "Crawl4AI",
    enableDoclingHint: "Docling необязателен. Включите его с помощью OBO_ENABLE_DOCLING=true — он устанавливается при первом запуске (большая загрузка).",
    enableCrawl4aiHint: "Локальный Crawl4AI необязателен. Включите его с помощью OBO_ENABLE_CRAWL4AI=true (устанавливается при первом запуске) или задайте CRAWL4AI_API_URL для использования удалённого сервера.",
    ...
    filesHelp: "После загрузки и обработки файлы больше не нужны. Большинству пользователей следует разрешить Obo автоматически удалять загруженные файлы из папки загрузок.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "Доступна новая версия Obo.",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Настройте, какие модели использовать для различных задач в Obo",
    missingRequiredModels: "Отсутствуют необходимые модели: {{models}}. Obo может работать некорректно без них.",
  ...
  apiKeys: {
    description: "Храните API-ключи в базе данных для безопасного подключения провайдеров ИИ в Obo.",
    encryptionRequired: "Ключ шифрования не настроен",
    encryptionRequiredDescription: "Установите переменную окружения OBO_ENCRYPTION_KEY в любую секретную строку для хранения API-ключей в базе данных.",
  ...
  setupBanner: {
    encryptionRequired: "Ключ шифрования не настроен",
    encryptionRequiredDescription: "Установите переменную окружения OBO_ENCRYPTION_KEY для безопасного хранения учётных данных.",
