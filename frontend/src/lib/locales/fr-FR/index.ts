...
export const frFR = {
  ...
  connectionErrors: {
    ...
    apiDesc: "Le serveur API de Obo est injoignable",
  ...
  notebooks: {
    ...
    emptyTitle: "Ajoutez une source pour commencer",
    emptyDesc: "Le chat, les notes et Studio s'appuient sur vos sources. Ajoutez-en une pour commencer.",
    updated: "Mis à jour",
  ...
  settings: {
    sectionProcessing: "Traitement",
    sectionPodcastProfiles: "Profils de podcast",
    preferences: "Préférences",
    preferencesDesc: "Thème et langue pour ce navigateur",
    workspace: "Espace de travail",
    workspaceDesc: "Gérez qui peut accéder à cet espace de travail",
    localAccountDesc: "Vous êtes connecté avec un mot de passe local ; il n'y a aucun profil de compte à afficher.",
    ...
    jina: "Jina",
    crawl4ai: "Crawl4AI",
    enableDoclingHint: "Docling est facultatif. Activez-le avec OBO_ENABLE_DOCLING=true — il s'installe au premier démarrage (téléchargement volumineux).",
    enableCrawl4aiHint: "Crawl4AI local est facultatif. Activez-le avec OBO_ENABLE_CRAWL4AI=true (s'installe au premier démarrage), ou définissez CRAWL4AI_API_URL pour utiliser un serveur distant.",
    ...
    filesHelp: "Une fois vos fichiers téléchargés et traités, ils ne sont plus nécessaires. La plupart des utilisateurs devraient autoriser Obo à supprimer automatiquement les fichiers du dossier de téléchargement.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "Une nouvelle version de Obo est disponible.",
    upToDate: "À jour",
    unknown: "Inconnu",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configurez quels modèles utiliser pour les différents usages d'Obo",
    missingRequiredModels: "Modèles requis manquants : {{models}}. Obo pourrait ne pas fonctionner correctement sans eux.",
  ...
  apiKeys: {
    description: "Stockez les clés API de manière sécurisée dans la base de données pour activer les fournisseurs d'IA dans Obo.",
    encryptionRequired: "Clé de chiffrement non configurée",
    encryptionRequiredDescription: "Définissez la variable d'environnement OBO_ENCRYPTION_KEY avec une chaîne secrète pour activer le stockage des clés API dans la base de données.",
  ...
  setupBanner: {
    encryptionRequired: "Clé de chiffrement non configurée",
    encryptionRequiredDescription: "Définissez la variable d'environnement OBO_ENCRYPTION_KEY pour activer le stockage sécurisé des identifiants.",
