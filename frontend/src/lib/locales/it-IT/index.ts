...
export const itIT = {
  ...
  connectionErrors: {
    ...
    apiDesc: "Il server API di Obo non è raggiungibile",
  ...
  notebooks: {
    ...
    emptyTitle: "Aggiungi una fonte per iniziare",
    emptyDesc: "Chat, note e Studio si basano sulle tue fonti. Aggiungine una per iniziare.",
    updated: "Aggiornato",
  ...
  settings: {
    sectionProcessing: "Elaborazione",
    sectionPodcastProfiles: "Profili podcast",
    preferences: "Preferenze",
    preferencesDesc: "Tema e lingua per questo browser",
    workspace: "Area di lavoro",
    workspaceDesc: "Gestisci chi può accedere a quest'area di lavoro",
    localAccountDesc: "Hai effettuato l'accesso con una password locale, quindi non c'è alcun profilo account da mostrare.",
    ...
    jina: "Jina",
    crawl4ai: "Crawl4AI",
    enableDoclingHint: "Docling è facoltativo. Abilitalo con OBO_ENABLE_DOCLING=true — viene installato al primo avvio (download di grandi dimensioni).",
    enableCrawl4aiHint: "Crawl4AI locale è facoltativo. Abilitalo con OBO_ENABLE_CRAWL4AI=true (installato al primo avvio), oppure imposta CRAWL4AI_API_URL per usare un server remoto.",
    ...
    filesHelp: "Una volta caricati ed elaborati, i tuoi file non sono più necessari. La maggior parte degli utenti dovrebbe permettere a Obo di eliminare automaticamente i file caricati dalla cartella upload.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "È disponibile una nuova versione di Obo.",
    upToDate: "Aggiornato",
    unknown: "Sconosciuto",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configura quali modelli usare per diversi scopi in Obo",
    missingRequiredModels: "Modelli richiesti mancanti: {{models}}. Obo potrebbe non funzionare correttamente senza questi.",
  ...
  apiKeys: {
    description: "Salva le chiavi API in modo sicuro nel database per abilitare i provider IA in Obo.",
    encryptionRequired: "Chiave di crittografia non configurata",
    encryptionRequiredDescription: "Imposta la variabile d'ambiente OBO_ENCRYPTION_KEY su una stringa segreta qualsiasi per abilitare il salvataggio delle chiavi API nel database.",
  ...
  setupBanner: {
    encryptionRequired: "Chiave di crittografia non configurata",
    encryptionRequiredDescription: "Imposta la variabile d'ambiente OBO_ENCRYPTION_KEY per abilitare l'archiviazione sicura delle credenziali.",
