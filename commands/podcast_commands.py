...
from obo.podcasts.audio_paths import to_relative_audio_path
from obo.podcasts.models import (
    EpisodeProfile,
    PodcastEpisode,
    SpeakerProfile,
    _resolve_model_config,
)
from obo.utils.model_utils import full_model_dump
...
@command("generate_podcast", app="obo", retry={"max_attempts": 1})
async def generate_podcast_command(
    ...
    try:
        ...
        # in obo/graphs/transformation.py (GHSA-f35w-wx37-26q7).
