...
from obo.ai.models import model_manager
from obo.database.repository import ensure_record_id, repo_insert, repo_query
from obo.domain.notebook import Note, Source, SourceInsight
from obo.exceptions import ConfigurationError
from obo.utils.chunking import ContentType, chunk_text, detect_content_type
from obo.utils.embedding import generate_embedding, generate_embeddings
...
@command("embed_note", app="obo", retry=EMBED_RETRY_CONFIG)
...
@command("embed_insight", app="obo", retry=EMBED_RETRY_CONFIG)
...
@command("embed_source", app="obo", retry=EMBED_RETRY_CONFIG)
...
@command("create_insight", app="obo", retry=EMBED_RETRY_CONFIG)
...
@command("rebuild_embeddings", app="obo", retry=None)
