"""
Unit tests for the obo.domain module.
...
from obo.ai.models import ModelManager
from obo.domain.base import RecordModel
from obo.domain.content_settings import ContentSettings
from obo.domain.notebook import (
    Asset,
    Note,
    Notebook,
    Source,
...
from obo.exceptions import InvalidInputError
from obo.podcasts.models import EpisodeProfile, SpeakerProfile
...
class TestNotebookDomain:
    ...
    async def test_notebook_delete_cascades_chat_sessions(self):
        ...
        with (
            ...
            patch(
                "obo.domain.notebook.repo_query",
                new=AsyncMock(return_value=[]),
            ),
            patch(
                "obo.domain.base.repo_delete",
...
class TestSourceDomain:
    ...
    async def test_vectorize_submits_command_with_valid_text(self):
        ...
        with patch(
            "obo.domain.notebook.submit_command", return_value="command:123"
        ) as mock_submit:
...
class TestContentSettings:
    ...
    def test_content_settings_defaults(self):
        ...
        assert settings.record_id == "obo:content_settings"
