...
router into obo/utils/context_builder.py. They must pass
...
PATCH_NOTEBOOK = "obo.domain.notebook.Notebook.get"
PATCH_SOURCE = "obo.domain.notebook.Source.get"
PATCH_NOTE = "obo.domain.notebook.Note.get"
PATCH_INSIGHTS = "obo.domain.notebook.SourceInsight.get_for_sources"
