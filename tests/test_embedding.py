"""
Unit tests for the obo.utils.embedding module.
...
from obo.utils.chunking import CHUNK_SIZE
from obo.utils.embedding import (
    generate_embedding,
    generate_embeddings,
    mean_pool_embeddings,
)
from obo.utils.token_utils import token_count
...
class TestGenerateEmbeddings:
    ...
    async def test_no_model_raises(self):
        ...
        with patch(
            "obo.ai.models.model_manager.get_embedding_model",
...
class TestGenerateEmbedding:
    ...
    async def test_content_type_parameter(self):
        ...
        from obo.utils.chunking import ContentType
    ...
    async def test_batching(self):
        ...
        from obo.utils.embedding import EMBEDDING_BATCH_SIZE
    ...
    async def test_batch_retry_on_transient_failure(self):
        ...
        with (
            ...
            patch("obo.utils.embedding.EMBEDDING_RETRY_DELAY", 0),
        ):
            result = await generate_embeddings(texts)
    ...
    async def test_batch_retry_exhaustion(self):
        ...
        from obo.utils.embedding import EMBEDDING_MAX_RETRIES
...
class TestErrorClassifier413:
    ...
    def test_413_status_code(self):
        from obo.exceptions import ExternalServiceError
        from obo.utils.error_classifier import classify_error
