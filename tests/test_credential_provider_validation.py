...
(obo/ai/provider_registry.py): the registry is the backend
...
class TestProviderRegistryIsTheSourceOfTruth:
    ...
    def test_discovery_functions_cover_registry(self):
        from obo.ai.model_discovery import PROVIDER_DISCOVERY_FUNCTIONS
    ...
    def test_registry_rejects_duplicate_provider_names(self):
        ...
        from obo.ai.provider_registry import (
            ProviderSpec,
            _build_registry,
        )
    ...
    def test_openai_compat_discovery_urls_are_exactly_as_expected(self):
        ...
        from obo.ai.model_discovery import OPENAI_COMPAT_PROVIDERS
