...
class TestConfig:
    def test_default_is_100mb(self, monkeypatch):
        monkeypatch.delenv("OBO_MAX_UPLOAD_SIZE_MB", raising=False)
    ...
    def test_non_positive_env_falls_back_to_default(self, monkeypatch):
        ...
        monkeypatch.setenv("OBO_MAX_UPLOAD_SIZE_MB", "0")
        assert get_max_upload_size_bytes() == 100 * 1024 * 1024
        monkeypatch.setenv("OBO_MAX_UPLOAD_SIZE_MB", "-5")
        assert get_max_upload_size_bytes() == 100 * 1024 * 1024
