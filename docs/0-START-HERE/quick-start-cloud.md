...
Get Obo running with **Anthropic, Google, Groq, or other cloud providers**. Same simplicity as OpenAI, with more choices.
...
Create a new folder `obo` and add this file:
...
Open terminal in your `obo` folder:
