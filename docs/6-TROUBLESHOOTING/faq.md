...
Common questions about Obo usage, configuration, and best practices.
...
Obo is an open-source, privacy-focused alternative to Google's Notebook LM. It allows you to:
...
- Use `OBO_PASSWORD` for public deployments
...
3. Ask in [GitHub Discussions](https://github.com/renatobardi/obo/discussions/categories/q-a) or the Discord community
...
Submit to: [GitHub Issues](https://github.com/renatobardi/obo/issues)
