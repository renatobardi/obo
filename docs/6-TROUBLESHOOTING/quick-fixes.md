...
- Check that `OBO_ENCRYPTION_KEY` is set in docker-compose.yml
...
3. **Update regularly** — Pull latest image: `docker pull ghcr.io/renatobardi/obo:latest`
...
- **Ask for help:** [GitHub Issues](https://github.com/renatobardi/obo/issues)
