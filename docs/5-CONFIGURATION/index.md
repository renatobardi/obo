...
Configuration is how you customize Obo for your specific setup. This section covers what you need to know.
...
You will only use .env if you are running Obo locally.
...
1. Set `OBO_ENCRYPTION_KEY` in your environment (required for storing credentials)
2. Start services
...
2. Set OBO_ENCRYPTION_KEY and database vars
3. Save
4. Restart services
```
...
| Missing encryption key | Can't save credentials | Set OBO_ENCRYPTION_KEY |
...
1. Set `OBO_ENCRYPTION_KEY` in your environment
2. Start services
