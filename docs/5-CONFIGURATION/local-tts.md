...
> - **[docker-compose-speaches.yml](../../examples/docker-compose-speaches.yml)** - Speaches + Obo
...
```yaml
# In your Obo docker-compose.yml
environment:
...
# From inside Obo container
docker exec -it obo curl http://host.docker.internal:8969/v1/models
```
