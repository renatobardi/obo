...
Obo uses SurrealDB for its database needs. 

---

## Default Configuration

Obo should work out of the box with SurrealDB as long as the environment variables are correctly setup. 


### DB running in the same docker compose as Obo (recommended)
...
### DB running in the host machine and Obo running in Docker
...
### Obo and Surreal are running on the same machine
