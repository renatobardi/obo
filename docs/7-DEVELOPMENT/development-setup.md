...
This guide walks you through setting up Obo for local development. Follow these steps to get the full stack running on your machine.
...
git remote add upstream https://github.com/renatobardi/obo.git
```
...
OBO_ENCRYPTION_KEY=my-dev-secret-key

# Application
OBO_PASSWORD=  # Optional password protection
DEBUG=true
LOG_LEVEL=DEBUG
```
...
uv run pytest --cov=obo --cov-report=html
```
