...
Complete REST API for Obo. All endpoints are served from the API backend (default: `http://localhost:5055`).
...
Password configured via `OBO_PASSWORD` environment variable.
