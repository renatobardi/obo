...
Get Obo running locally in 5 minutes.
...
git clone https://github.com/YOUR_USERNAME/obo.git
cd obo
...
- **Frontend**: http://localhost:3000 → Obo UI
...
- **First Issue?** Pick a [good first issue](https://github.com/renatobardi/obo/issues?q=label%3A%22good+first+issue%22)
...
Need more help? See [Development Setup](development-setup.md) for details.
