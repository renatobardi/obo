...
- **Status**: Accepted
- **Date**: 2026-07
- **Related**: [change-playbooks.md](../change-playbooks.md) (Database Migration playbook)
...
- When the migration runner moves to surreal-basics, this policy transfers unchanged — it is about granularity and immutability-after-main, not about the runner.
