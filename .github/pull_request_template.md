...
**Which design principles does this PR support?** (See [VISION.md](https://github.com/renatobardi/obo/blob/main/VISION.md))
...
- [ ] I have read [CONTRIBUTING.md](https://github.com/renatobardi/obo/blob/main/docs/7-DEVELOPMENT/contributing.md)
- [ ] I have read [VISION.md](https://github.com/renatobardi/obo/blob/main/VISION.md)
...
**Thank you for contributing to Obo!** 🎉
