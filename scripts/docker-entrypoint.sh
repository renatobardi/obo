...
#
#   OBO_ENABLE_DOCLING=true   -> content-core[docling]  (Docling engine, OCR, image sources)
#   OBO_ENABLE_CRAWL4AI=true  -> content-core[crawl4ai] + Chromium  (local JS rendering)
#
...
# Docling
# ---------------------------------------------------------------------------
if is_true "$OBO_ENABLE_DOCLING"; then
...
# ---------------------------------------------------------------------------
if is_true "$OBO_ENABLE_CRAWL4AI"; then
