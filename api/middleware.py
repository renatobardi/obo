...
def get_max_upload_size_bytes() -> int:
    ...
    Configurable via OBO_MAX_UPLOAD_SIZE_MB for deployments that
    ...
    """
    raw = os.environ.get("OBO_MAX_UPLOAD_SIZE_MB", "").strip()
    try:
    ...
    if mb <= 0:
        logger.warning(
            f"OBO_MAX_UPLOAD_SIZE_MB={raw!r} is not a positive size; "
