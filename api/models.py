...
class ApiKeyStatusResponse(BaseModel):
    ...
    encryption_configured: bool = Field(
        ...,
        description="Whether OBO_ENCRYPTION_KEY is set (required to store keys in database)",
    )
...
# (obo/ai/provider_registry.py PROVIDERS — the backend source of
...
class CapabilitiesResponse(BaseModel):
    ...
    what the OBO_ENABLE_* flags request — so the UI can gate engine
