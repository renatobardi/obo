...
Encryption is enabled when OBO_ENCRYPTION_KEY environment variable
...
from obo.database.repository import ensure_record_id, repo_query, repo_upsert
from obo.domain.base import RecordModel
from obo.utils.encryption import decrypt_value, encrypt_value
...
class ProviderConfig(RecordModel):
    ...
    record_id: ClassVar[str] = "obo:provider_configs"
    ...
    def _prepare_save_data(self) -> dict:
        ...
        OBO_ENCRYPTION_KEY is configured.
        """
