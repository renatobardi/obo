...
This lives in obo.utils (not api/) because both layers need it: the
...
_ENGINE_RUNTIMES: dict[str, tuple[str, str]] = {
    "crawl4ai": ("crawl4ai_available", "OBO_ENABLE_CRAWL4AI"),
    "docling": ("docling_available", "OBO_ENABLE_DOCLING"),
}
