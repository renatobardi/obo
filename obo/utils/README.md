...
A flexible and generic ContextBuilder class for the Obo project that can handle any parameters and build context from sources, notebooks, insights, and notes.
...
```python
from obo.utils.context_builder import ContextBuilder, ContextConfig
...
```python
from obo.utils.context_builder import (
...
```python
from obo.utils.context_builder import ContextConfig
...
```python
from obo.utils.context_builder import ContextItem
...
The ContextBuilder integrates seamlessly with the existing Obo architecture:
