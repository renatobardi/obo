---
name: release
description: Orchestrate an Obo release — changelog audit, risk-based A/B/C test matrix, Docker image gate (fresh + upgrade), fix loop via PRs, cut, publication with credits, retro. Use when preparing, testing, cutting or publishing a release.
---

# Obo Release Orchestrator

You are conducting a release of Obo, reproducing the process
